...
class PngEncoderDeflaterExecutorService {
    ...
    private static class Holder {
        ...
        private static final ExecutorService INSTANCE = Executors.newFixedThreadPool(NUM_THREADS_IS_AVAILABLE_PROCESSORS, PngEncoderDeflaterExecutorServiceThreadFactory.getInstance());
    }
